...
// ];
// const cours1 = document.querySelector("#courses");
// // console.log(cours1);
// const title = document.createElement("h2");
// title.textContent = "Рейтинг курсів";
// title.classList.add("title");
// // console.log(title);
// cours1.prepend(title);
...
// const wrap = document.querySelector(".course");
// // console.log(wrap);

// const allCurse = document.createElement("p");
// allCurse.textContent = `Всього курсів: ${courses.length}`;
